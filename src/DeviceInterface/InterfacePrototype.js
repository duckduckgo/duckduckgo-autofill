...
class InterfacePrototype {
                    ...
                    switch (id) {
                        ...
                        default:
                            ...
                            const checks = [
                                ...
                                this.data.hasLocalAddresses,
                                data?.emailAddress === formatDuckAddress(this.data.addresses.personalAddress)
                            ]
    ...
    async getAutofillIdentity(id) {
        const identity = this.data.getLocalIdentities().find(({id: identityId}) => `${identityId}` === `${id}`)
