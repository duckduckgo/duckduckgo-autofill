...
// Derived by the Intl.DisplayNames implementation
...
const COUNTRY_NAMES_TO_CODES = Object.fromEntries(
    Object.entries(COUNTRY_CODES_TO_NAMES).map(entry => [entry[1], entry[0]])
)
console.log('COUNTRY_NAMES_TO_CODES: ', COUNTRY_NAMES_TO_CODES)
