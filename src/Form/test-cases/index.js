export default [
    ...
    { html: 'facebook_signup.html', expectedSubmitFalseNegatives: 1 },
    { html: 'twitter_login.html', expectedSubmitFalseNegatives: 1 },
    { html: 'twitter_signup.html', expectedFailures: ['birthdayMonth', 'birthdayDay', 'birthdayYear'], expectedSubmitFalsePositives: 1, expectedSubmitFalseNegatives: 1 },
    ...
    { html: 'reddit_login.html', expectedSubmitFalsePositives: 1, expectedSubmitFalseNegatives: 1 },
    ...
    { html: 'instagram_signup.html', expectedSubmitFalsePositives: 1, expectedSubmitFalseNegatives: 1 },
    { html: 'ebay_login.html', expectedSubmitFalseNegatives: 1 },
    { html: 'ebay_signup.html' },
    { html: 'ebay_checkout.html', expectedFailures: ['unknown', 'unknown'], expectedSubmitFalsePositives: 2 },
    { html: 'walmart_login.html' },
    { html: 'walmart_signup.html' },
    { html: 'walmart_checkout.html', expectedFailures: ['unknown', 'unknown'], expectedSubmitFalsePositives: 2 },
    { html: 'craigslist_account.html', expectedSubmitFalseNegatives: 1 },
    ...
    { html: 'apple_signup.html', expectedFailures: ['birthday', 'unknown'], expectedSubmitFalsePositives: 3, expectedSubmitFalseNegatives: 1 },
    { html: 'apple_checkout.html', expectedSubmitFalsePositives: 4, expectedSubmitFalseNegatives: 2 },
    ...
    { html: 'google_login.html', expectedSubmitFalsePositives: 2, expectedSubmitFalseNegatives: 1 },
    { html: 'google_signup.html', expectedFailures: ['username'], expectedSubmitFalsePositives: 1, expectedSubmitFalseNegatives: 1 },
    { html: 'google_store_checkout.html', expectedSubmitFalsePositives: 1, expectedSubmitFalseNegatives: 1 },
    ...
    { html: 'microsoft_signup.html', expectedFailures: ['username'], expectedSubmitFalsePositives: 1, expectedSubmitFalseNegatives: 1 },
    ...
    { html: 'usps_login.html', expectedSubmitFalsePositives: 1, expectedSubmitFalseNegatives: 1 },
    { html: 'usps_signup.html', expectedSubmitFalseNegatives: 1 },
    { html: 'usps_checkout.html', expectedSubmitFalseNegatives: 2, expectedSubmitFalsePositives: 1 },
    ...
    { html: 'lowes_checkout.html', expectedSubmitFalseNegatives: 1, expectedSubmitFalsePositives: 62 },
    ...
    { html: 'mapquest_login.html', expectedSubmitFalseNegatives: 1, expectedSubmitFalsePositives: 1 },
    { html: 'mapquest_signup.html', expectedFailures: ['birthdayMonth', 'birthdayDay', 'birthdayYear'], expectedSubmitFalsePositives: 1 },
    { html: 'fox_login.html' },
    ...
    { html: 'bestbuy_checkout.html', expectedSubmitFalseNegatives: 1, expectedSubmitFalsePositives: 3 },
    { html: 'rottentomatoes_login.html', expectedSubmitFalseNegatives: 1, expectedSubmitFalsePositives: 1 },
    { html: 'rottentomatoes_signup.html', expectedSubmitFalseNegatives: 1, expectedSubmitFalsePositives: 1 },
    { html: 'costco_login.html' },
    { html: 'costco_signup.html' },
    { html: 'costco_checkout.html', expectedSubmitFalseNegatives: 1, expectedSubmitFalsePositives: 3 },
    ...
    { html: 'chewy_checkout.html', expectedSubmitFalseNegatives: 2, expectedSubmitFalsePositives: 3 },
    ...
    { html: 'stripeelements_checkout.html', expectedSubmitFalseNegatives: 5, expectedSubmitFalsePositives: 7 },
    { html: 'litmus_home_search.html', expectedSubmitFalsePositives: 1 },
    { html: 'litmus_home_new.html', expectedFailures: ['unknown', 'unknown'] },
    { html: 'asana_tasklist.html', expectedSubmitFalsePositives: 9 },
    { html: 'asana_search.html', expectedSubmitFalsePositives: 1 },
    { html: 'aa_login.html' },
    ...
    { html: 'samash_checkout.html', expectedFailures: ['emailAddress'], expectedSubmitFalsePositives: 1 },
    ...
    { html: 'coinmarketcap_login.html' },
    { html: 'coinmarketcap_signup.html' },
    ...
    { html: 'vulture_signup.html', expectedFailures: ['unknown', 'unknown'] },
