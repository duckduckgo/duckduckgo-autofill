...
test.describe('android', () => {
    test.describe('when signed in', () => {
        test('should autofill the selected email', async ({ page }) => {
            ...
            await createAndroidMocks().withPersonalEmail(personalAddress).withPrivateEmail(personalAddress).applyTo(page);

            // create + inject the script
            await createAutofillScript().replaceAll(androidStringReplacements()).platform('android').applyTo(page);
        ...
        test('should store form data when using private or personal address', async ({ page }) => {
            ...
            await createAndroidMocks().withPersonalEmail(personalAddress).withPrivateEmail(privateAddress0).applyTo(page);
    ...
    test.describe('password generation', () => {
        ...
        test('should not autofill when password rejected', async ({ page }) => {
            ...
            // android specific mocks
            await createAndroidMocks().withPasswordDecision?.('reject').applyTo(page);
