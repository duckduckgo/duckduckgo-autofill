...
function createDevice() {
  ...
  const transport = (0, _transports.createTransport)(globalConfig); // Create the DeviceAPI + Setting

  let deviceApi = new _index.DeviceApi(transport);
...
class InterfacePrototype {
  ...
  constructor(config, deviceApi, settings) {
    ...
    _defineProperty(this, "lastEmailProtectionAddressUsed", null);
  ...
  postAutofill(data, dataType, formObj) {
    ...
    !this.globalConfig.isAndroid) {
      ...
      if (((_formValues$credentia = formValues.credentials) === null || _formValues$credentia === void 0 ? void 0 : _formValues$credentia.password) === data.password) {
        const formData = (0, _autofillUtils.prepareForFormStorage)(formValues, 'passwordGeneration', data.password, undefined);
    ...
    if (((data === null || data === void 0 ? void 0 : data.id) === 'privateAddress' || (data === null || data === void 0 ? void 0 : data.id) === 'personalAddress' || (data === null || data === void 0 ? void 0 : data.id) === 'emailProtectionAddress') && 'emailAddress' in data && typeof data.emailAddress === 'string') {
       ...
       */
      if (!this.globalConfig.isMobileApp && data.id === 'privateAddress') {
        ...
        const formData = (0, _autofillUtils.prepareForFormStorage)(formValues, 'emailProtection', undefined, undefined);
        this.storeFormData(formData);
      }
      /**
       * All platforms, store the fact we used a personal or private address
       */


      this.lastEmailProtectionAddressUsed = data.emailAddress;
    }
  ...
  postSubmit(values, form) {
    ...
    if (checks.some(Boolean)) {
      const formData = (0, _autofillUtils.prepareForFormStorage)(values, 'formSubmission', this.passwordGenerator.password, this.lastEmailProtectionAddressUsed);
      this.storeFormData(formData);
    }
  }
  /**
...
exports.appendGeneratedIdForEmail = appendGeneratedIdForEmail;
...
function appendGeneratedIdForEmail(data, email) {
  var _data$credentials2;

  if (email && ((_data$credentials2 = data.credentials) === null || _data$credentials2 === void 0 ? void 0 : _data$credentials2.username) === email) {
    return { ...data,
      credentials: { ...data.credentials,
        [AUTOGENERATED_KEY]: true
      }
 ...
 * @param {string | undefined | null} generatedEmail
 * @returns {DataStorageObject}
 */
...
const prepareForFormStorage = (data, trigger, generatedPassword, generatedEmail) => {
  const withGeneratedPassword = (0, _Credentials.appendGeneratedId)(data, generatedPassword);
  const withEmail = (0, _Credentials.appendGeneratedIdForEmail)(withGeneratedPassword, generatedEmail);
  withEmail.trigger = trigger;
  return withEmail;
