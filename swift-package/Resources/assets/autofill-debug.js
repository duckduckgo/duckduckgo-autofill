...
exports.toString = exports.removeEventListener = exports.randomUUID = exports.objectKeys = exports.objectEntries = exports.objectDefineProperty = exports.hasOwnProperty = exports.getOwnPropertyDescriptors = exports.getOwnPropertyDescriptor = exports.functionToString = exports.dispatchEvent = exports.customElementsGet = exports.customElementsDefine = exports.addEventListener = exports.URL = exports.TypeError = exports.Symbol = exports.String = exports.Set = exports.Reflect = exports.Proxy = exports.Promise = exports.Map = exports.Error = exports.CustomEvent = void 0;
/* eslint-disable no-redeclare */
const Set = exports.Set = globalThis.Set;
const Reflect = exports.Reflect = globalThis.Reflect;
const customElementsGet = exports.customElementsGet = globalThis.customElements?.get.bind(globalThis.customElements);
const customElementsDefine = exports.customElementsDefine = globalThis.customElements?.define.bind(globalThis.customElements);
const getOwnPropertyDescriptor = exports.getOwnPropertyDescriptor = Object.getOwnPropertyDescriptor;
const getOwnPropertyDescriptors = exports.getOwnPropertyDescriptors = Object.getOwnPropertyDescriptors;
const toString = exports.toString = Object.prototype.toString;
const objectKeys = exports.objectKeys = Object.keys;
const objectEntries = exports.objectEntries = Object.entries;
const objectDefineProperty = exports.objectDefineProperty = Object.defineProperty;
const URL = exports.URL = globalThis.URL;
const Proxy = exports.Proxy = globalThis.Proxy;
const functionToString = exports.functionToString = Function.prototype.toString;
const TypeError = exports.TypeError = globalThis.TypeError;
const Symbol = exports.Symbol = globalThis.Symbol;
const hasOwnProperty = exports.hasOwnProperty = Object.prototype.hasOwnProperty;
const dispatchEvent = exports.dispatchEvent = globalThis.dispatchEvent?.bind(globalThis);
const addEventListener = exports.addEventListener = globalThis.addEventListener?.bind(globalThis);
const removeEventListener = exports.removeEventListener = globalThis.removeEventListener?.bind(globalThis);
const CustomEvent = exports.CustomEvent = globalThis.CustomEvent;
const Promise = exports.Promise = globalThis.Promise;
const String = exports.String = globalThis.String;
const Map = exports.Map = globalThis.Map;
const Error = exports.Error = globalThis.Error;
const randomUUID = exports.randomUUID = globalThis.crypto?.randomUUID?.bind(globalThis.crypto);
...
var _immutableJsonPatch = require("immutable-json-patch");
...
class ConfigFeature {
  ...
  constructor(name, args) {
    ...
    if (this.#bundledConfig && this.#args) {
      const enabledFeatures = (0, _utils.computeEnabledFeatures)(bundledConfig, site.domain, platform.version);
      this.#args.featureSettings = (0, _utils.parseFeatureSettings)(bundledConfig, enabledFeatures);
    }
  }
  get args() {
    return this.#args;
    ...
    return domains.filter(rule => {
      if (Array.isArray(rule.domain)) {
        return rule.domain.some(domainRule => {
          return (0, _utils.matchHostname)(domain, domainRule);
        });
      }
      return (0, _utils.matchHostname)(domain, rule.domain);
    });
  }
  ...
  _getFeatureSettings(featureName) {
    const camelFeatureName = featureName || (0, _utils.camelcase)(this.name);
  ...
  */
  getFeatureSetting(featureKeyName, featureName) {
    ...
    for (const match of domainMatch) {
      ...
      try {
        result = (0, _immutableJsonPatch.immutableJSONPatch)(result, match.patchSettings);
      } catch (e) {
...
exports.default = ConfigFeature;

},{"./utils.js":3,"immutable-json-patch":4}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.OriginalCustomEvent = exports.DDGReflect = exports.DDGProxy = exports.DDGPromise = void 0;
exports.camelcase = camelcase;
exports.computeEnabledFeatures = computeEnabledFeatures;
exports.computeLimitedSiteObject = computeLimitedSiteObject;
exports.createCustomEvent = createCustomEvent;
exports.createStyleElement = createStyleElement;
exports.getContextId = getContextId;
exports.getInjectionElement = getInjectionElement;
exports.getStack = getStack;
exports.getStackTraceOrigins = getStackTraceOrigins;
exports.getStackTraceUrls = getStackTraceUrls;
exports.getTabHostname = getTabHostname;
exports.hasThirdPartyOrigin = hasThirdPartyOrigin;
exports.initStringExemptionLists = initStringExemptionLists;
exports.injectGlobalStyles = injectGlobalStyles;
exports.isBeingFramed = isBeingFramed;
exports.isFeatureBroken = isFeatureBroken;
exports.isGloballyDisabled = isGloballyDisabled;
exports.isPlatformSpecificFeature = isPlatformSpecificFeature;
exports.isThirdPartyFrame = isThirdPartyFrame;
exports.isUnprotectedDomain = isUnprotectedDomain;
exports.iterateDataKey = iterateDataKey;
exports.legacySendMessage = legacySendMessage;
exports.matchHostname = matchHostname;
exports.nextRandom = nextRandom;
exports.originalWindowDispatchEvent = void 0;
exports.parseFeatureSettings = parseFeatureSettings;
exports.platformSpecificFeatures = void 0;
exports.postDebugMessage = postDebugMessage;
exports.processAttr = processAttr;
exports.processConfig = processConfig;
exports.registerMessageSecret = registerMessageSecret;
...
var _capturedGlobals = require("./captured-globals.js");
...
const OriginalCustomEvent = exports.OriginalCustomEvent = typeof CustomEvent === 'undefined' ? null : CustomEvent;
const originalWindowDispatchEvent = exports.originalWindowDispatchEvent = typeof window === 'undefined' ? null : window.dispatchEvent.bind(window);
 ...
 */
function setGlobal(globalObjIn) {
...
function hasThirdPartyOrigin(scriptOrigins) {
...
function getStackTraceUrls(stack) {
  const urls = new _capturedGlobals.Set();
  try {
...
function getStackTraceOrigins(stack) {
  ...
  const origins = new _capturedGlobals.Set();
    ...
    const outputHandler = function () {
      ...
      if (debug) {
        postDebugMessage(_this.camelFeatureName, {
          ...
          stack: getStack(),
          args: debugSerialize(arguments.length <= 2 ? undefined : arguments[2])
        });
      }
      // The normal return value
      if (isExempt) {
        return DDGReflect.apply(arguments.length <= 0 ? undefined : arguments[0], arguments.length <= 1 ? undefined : arguments[1], arguments.length <= 2 ? undefined : arguments[2]);
      }
...
function postDebugMessage(feature, message) {
  let allowNonDebug = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
...
const DDGPromise = exports.DDGPromise = globalObj.Promise;
const DDGReflect = exports.DDGReflect = globalObj.Reflect;
...
function stripVersion(version) {
  let keepComponents = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
...
function processConfig(data, userList, preferences) {
  let platformSpecificFeatures = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : [];
  const topLevelHostname = getTabHostname();
 ...
 * @returns {string[]}
 */
function computeEnabledFeatures(data, topLevelHostname, platformVersion) {
  let platformSpecificFeatures = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : [];
 ...
 * @type {FeatureName[]}
 */
const platformSpecificFeatures = exports.platformSpecificFeatures = ['windowsPermissionUsage', 'messageBridge'];
...
function legacySendMessage(messageType, options) {
  // FF & Chrome
  return originalWindowDispatchEvent && originalWindowDispatchEvent(createCustomEvent('sendMessageProxy' + messageSecret, {
 ...
 */
function withExponentialBackoff(fn) {
  let maxAttempts = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 4;
...
},{"./captured-globals.js":1}],4:[function(require,module,exports){
"use strict";

(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define(['exports'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.immutableJSONPatch = {}));
...
},{"./ZodError":5,"./errors":6,"./helpers/errorUtil":8,"./helpers/parseUtil":9,"./helpers/util":11}],15:[function(require,module,exports){
"use strict";
...
},{"./lib/device-api-call.js":16,"./lib/device-api.js":17}],16:[function(require,module,exports){
"use strict";
...
},{"./webkit.js":19}],19:[function(require,module,exports){
"use strict";
...
},{"./messaging.js":18}],20:[function(require,module,exports){
"use strict";
...
},{"./lib/apple.password.js":21,"./lib/constants.js":22,"./lib/rules-parser.js":23}],21:[function(require,module,exports){
"use strict";
...
},{"./constants.js":22,"./rules-parser.js":23}],22:[function(require,module,exports){
"use strict";
...
},{"./deviceApiCalls/__generated__/deviceApiCalls.js":71}],26:[function(require,module,exports){
"use strict";
...
},{"../packages/device-api/index.js":15,"./DeviceInterface/AndroidInterface.js":27,"./DeviceInterface/AppleDeviceInterface.js":28,"./DeviceInterface/AppleOverlayDeviceInterface.js":29,"./DeviceInterface/ExtensionInterface.js":30,"./DeviceInterface/WindowsInterface.js":32,"./DeviceInterface/WindowsOverlayDeviceInterface.js":33,"./Settings.js":54,"./config.js":69,"./deviceApiCalls/transports/transports.js":77}],27:[function(require,module,exports){
"use strict";
...
},{"../InContextSignup.js":48,"../UI/controllers/NativeUIController.js":62,"../autofill-utils.js":67,"../deviceApiCalls/__generated__/deviceApiCalls.js":71,"./InterfacePrototype.js":31}],28:[function(require,module,exports){
"use strict";
...
},{"../../packages/device-api/index.js":15,"../Form/matching.js":47,"../InContextSignup.js":48,"../ThirdPartyProvider.js":55,"../UI/HTMLTooltip.js":60,"../UI/controllers/HTMLTooltipUIController.js":61,"../UI/controllers/NativeUIController.js":62,"../UI/controllers/OverlayUIController.js":63,"../autofill-utils.js":67,"../deviceApiCalls/__generated__/deviceApiCalls.js":71,"../deviceApiCalls/additionalDeviceApiCalls.js":73,"./InterfacePrototype.js":31}],29:[function(require,module,exports){
"use strict";
...
},{"../../packages/device-api/index.js":15,"../UI/controllers/HTMLTooltipUIController.js":61,"./AppleDeviceInterface.js":28,"./overlayApi.js":35}],30:[function(require,module,exports){
"use strict";
...
},{"../Form/matching.js":47,"../InContextSignup.js":48,"../UI/HTMLTooltip.js":60,"../UI/controllers/HTMLTooltipUIController.js":61,"../autofill-utils.js":67,"./InterfacePrototype.js":31}],31:[function(require,module,exports){
"use strict";
...
},{"../../packages/device-api/index.js":15,"../CredentialsImport.js":25,"../EmailProtection.js":36,"../Form/formatters.js":40,"../Form/matching.js":47,"../InputTypes/Credentials.js":49,"../PasswordGenerator.js":52,"../Scanner.js":53,"../Settings.js":54,"../UI/controllers/NativeUIController.js":62,"../autofill-utils.js":67,"../config.js":69,"../deviceApiCalls/__generated__/deviceApiCalls.js":71,"../deviceApiCalls/transports/transports.js":77,"../locales/strings.js":102,"./initFormSubmissionsApi.js":34}],32:[function(require,module,exports){
"use strict";
...
},{"../UI/controllers/OverlayUIController.js":63,"../deviceApiCalls/__generated__/deviceApiCalls.js":71,"./InterfacePrototype.js":31}],33:[function(require,module,exports){
"use strict";
...
},{"../UI/controllers/HTMLTooltipUIController.js":61,"../deviceApiCalls/__generated__/deviceApiCalls.js":71,"./InterfacePrototype.js":31,"./overlayApi.js":35}],34:[function(require,module,exports){
"use strict";
...
},{"../Form/label-util.js":43,"../autofill-utils.js":67}],35:[function(require,module,exports){
"use strict";
...
},{"../deviceApiCalls/__generated__/deviceApiCalls.js":71}],36:[function(require,module,exports){
"use strict";
...
},{"../InputTypes/Credentials.js":49,"../autofill-utils.js":67,"../constants.js":70,"./FormAnalyzer.js":38,"./formatters.js":40,"./inputStyles.js":41,"./inputTypeConfig.js":42,"./matching.js":47}],38:[function(require,module,exports){
"use strict";
...
},{"../autofill-utils.js":67,"../constants.js":70,"./matching-config/__generated__/compiled-matching-config.js":45,"./matching.js":47}],39:[function(require,module,exports){
"use strict";
...
},{"../autofill-utils.js":67,"./countryNames.js":39,"./matching.js":47}],41:[function(require,module,exports){
"use strict";
...
},{"./inputTypeConfig.js":42}],42:[function(require,module,exports){
"use strict";
...
},{"../InputTypes/Credentials.js":49,"../InputTypes/CreditCard.js":50,"../InputTypes/Identity.js":51,"../UI/img/ddgPasswordIcon.js":65,"../constants.js":70,"./logo-svg.js":44,"./matching.js":47}],43:[function(require,module,exports){
"use strict";
...
},{"./matching.js":47}],44:[function(require,module,exports){
"use strict";
...
},{"../autofill-utils.js":67,"./matching.js":47}],47:[function(require,module,exports){
"use strict";
...
},{"../autofill-utils.js":67,"../constants.js":70,"./label-util.js":43,"./matching-config/__generated__/compiled-matching-config.js":45,"./matching-utils.js":46}],48:[function(require,module,exports){
"use strict";
...
},{"./autofill-utils.js":67,"./deviceApiCalls/__generated__/deviceApiCalls.js":71}],49:[function(require,module,exports){
"use strict";
...
},{"../autofill-utils.js":67}],50:[function(require,module,exports){
"use strict";
...
},{"../Form/formatters.js":40}],52:[function(require,module,exports){
"use strict";
...
},{"../packages/password/index.js":20,"../packages/password/rules.json":24}],53:[function(require,module,exports){
"use strict";
...
},{"./Form/Form.js":37,"./Form/matching.js":47,"./autofill-utils.js":67,"./constants.js":70,"./deviceApiCalls/__generated__/deviceApiCalls.js":71}],54:[function(require,module,exports){
"use strict";
...
},{"../packages/device-api/index.js":15,"./autofill-utils.js":67,"./deviceApiCalls/__generated__/deviceApiCalls.js":71,"./deviceApiCalls/__generated__/validators.zod.js":72}],55:[function(require,module,exports){
"use strict";
...
},{"../packages/device-api/index.js":15,"./Form/matching.js":47,"./deviceApiCalls/__generated__/deviceApiCalls.js":71,"./deviceApiCalls/__generated__/validators.zod.js":72}],56:[function(require,module,exports){
"use strict";
...
},{"./HTMLTooltip.js":60}],57:[function(require,module,exports){
"use strict";
...
},{"../InputTypes/Credentials.js":49,"../autofill-utils.js":67,"./HTMLTooltip.js":60}],58:[function(require,module,exports){
"use strict";
...
},{"../autofill-utils.js":67,"./HTMLTooltip.js":60}],59:[function(require,module,exports){
"use strict";
...
},{"./HTMLTooltip.js":60}],60:[function(require,module,exports){
"use strict";
...
},{"../Form/matching.js":47,"../autofill-utils.js":67,"./styles/styles.js":66}],61:[function(require,module,exports){
"use strict";
...
},{"../../Form/inputTypeConfig.js":42,"../../Form/matching.js":47,"../../autofill-utils.js":67,"../CredentialsImportTooltip.js":56,"../DataHTMLTooltip.js":57,"../EmailHTMLTooltip.js":58,"../EmailSignupHTMLTooltip.js":59,"../HTMLTooltip.js":60,"./UIController.js":64}],62:[function(require,module,exports){
"use strict";
...
},{"../../Form/matching.js":47,"../../InputTypes/Credentials.js":49,"../../deviceApiCalls/__generated__/deviceApiCalls.js":71,"./UIController.js":64}],63:[function(require,module,exports){
"use strict";
...
},{"../../Form/matching.js":47,"./UIController.js":64}],64:[function(require,module,exports){
"use strict";
...
var _matching = require("./Form/matching.js");
var _constants = require("./constants.js");
var _utils = require("@duckduckgo/content-scope-scripts/injected/src/utils");
var _remoteRules = _interopRequireDefault(require("./remote-rules.js"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
...
const autofillEnabled = globalConfig => {
  ...
  // @ts-ignore
  const processedConfig = (0, _utils.processConfig)(contentScope, userUnprotectedDomains, userPreferences);
  ...
  const remoteRules = new _remoteRules.default('autofill', loadArgs);
...
},{"./Form/matching.js":47,"./constants.js":70,"./remote-rules.js":107,"@duckduckgo/content-scope-scripts/injected/src/utils":3}],68:[function(require,module,exports){
"use strict";
...
},{"./DeviceInterface.js":26,"./autofill-utils.js":67,"./requestIdleCallback.js":108}],69:[function(require,module,exports){
"use strict";
...
},{"../../../packages/device-api":15,"./validators.zod.js":72}],72:[function(require,module,exports){
"use strict";
...
},{"zod":12}],73:[function(require,module,exports){
"use strict";
...
},{"../../packages/device-api/index.js":15,"./__generated__/validators.zod.js":72}],74:[function(require,module,exports){
"use strict";
...
},{"../../../packages/device-api/index.js":15,"../__generated__/deviceApiCalls.js":71}],75:[function(require,module,exports){
"use strict";
...
},{"../../../packages/device-api/index.js":15,"../../../packages/messaging/messaging.js":18}],76:[function(require,module,exports){
"use strict";
...
},{"../../../packages/device-api/index.js":15,"../../Settings.js":54,"../../autofill-utils.js":67,"../__generated__/deviceApiCalls.js":71}],77:[function(require,module,exports){
"use strict";
...
},{"./android.transport.js":74,"./apple.transport.js":75,"./extension.transport.js":76,"./windows.transport.js":78}],78:[function(require,module,exports){
"use strict";
...
},{"../../../packages/device-api/index.js":15}],79:[function(require,module,exports){
module.exports={
  "smartling" : {
    "string_format" : "icu",
    "translate_paths" : [
...
},{"./translations.js":105}],103:[function(require,module,exports){
module.exports={
  "smartling" : {
    "string_format" : "icu",
    "translate_paths" : [
...
},{"./bg/autofill.json":79,"./cs/autofill.json":80,"./da/autofill.json":81,"./de/autofill.json":82,"./el/autofill.json":83,"./en/autofill.json":84,"./es/autofill.json":85,"./et/autofill.json":86,"./fi/autofill.json":87,"./fr/autofill.json":88,"./hr/autofill.json":89,"./hu/autofill.json":90,"./it/autofill.json":91,"./lt/autofill.json":92,"./lv/autofill.json":93,"./nb/autofill.json":94,"./nl/autofill.json":95,"./pl/autofill.json":96,"./pt/autofill.json":97,"./ro/autofill.json":98,"./ru/autofill.json":99,"./sk/autofill.json":100,"./sl/autofill.json":101,"./sv/autofill.json":103,"./tr/autofill.json":104,"./xa/autofill.json":106}],106:[function(require,module,exports){
module.exports={
  "smartling": {
    "string_format": "icu",
    "translate_paths": [
...
exports.default = void 0;
var _configFeature = _interopRequireDefault(require("@duckduckgo/content-scope-scripts/injected/src/config-feature"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
class RemoteRules extends _configFeature.default {
  constructor(name, args) {
    super(name, args);
    console.log('DEEP remote rules', this.featureSettings);
  }
}
exports.default = RemoteRules;

},{"@duckduckgo/content-scope-scripts/injected/src/config-feature":2}],108:[function(require,module,exports){
"use strict";
