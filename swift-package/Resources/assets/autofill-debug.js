...
class AndroidMessagingTransport {
  ...
  constructor(config) {
    ...
    if (!('ddgAndroidAutofillHandler' in window)) {
      throw new _messaging.MissingHandler(`Missing android handler`, 'ddgAndroidAutofillHandler');
    }
...
},{"./DeviceInterface.js":23,"./autofill-utils.js":63,"./requestIdleCallback.js":79}],65:[function(require,module,exports){
"use strict";
...
},{"./translations.js":77}],77:[function(require,module,exports){
"use strict";
...
},{"./en/autofill.json":75,"./xa/autofill.json":78}],78:[function(require,module,exports){
module.exports={
  "smartling": {
    "string_format": "icu",
    "translate_paths": [
