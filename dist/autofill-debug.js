...
`.trim();
  ...
  var emailProtectionGetAliasParamsSchema = z.object({
    requiresUserPermission: z.boolean(),
    shouldConsumeAliasIfProvided: z.boolean(),
    isIncontextSignupAvailable: z.boolean().optional()
  });
  ...
  var emailProtectionGetAliasResultSchema = z.object({
    success: z.object({
      alias: z.string()
    }).optional(),
    error: genericErrorSchema.optional()
  ...
  var EmailProtectionGetAliasCall = class extends DeviceApiCall {
    constructor() {
      super(...arguments);
      __publicField(this, "method", "emailProtectionGetAlias");
      __publicField(this, "id", "emailProtectionGetAliasResponse");
      __publicField(this, "paramsValidator", emailProtectionGetAliasParamsSchema);
      __publicField(this, "resultValidator", emailProtectionGetAliasResultSchema);
    }
  };
  ...
  var AndroidMessagingTransport = class {
    ...
    constructor(config) {
      ...
      __publicField(this, "config");
      __publicField(this, "globals", { capturedHandlers: {} });
      this.config = config;
    }
    /**
  ...
  var AndroidInterface = class extends InterfacePrototype_default {
    ...
    async getAlias() {
      ...
      if (this.settings.availableInputTypes.email) {
        ...
        return alias ? formatDuckAddress(alias) : void 0;
      }
    }
    /**
     * @override
