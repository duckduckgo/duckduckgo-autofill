...
const startCredentialsImportFlowResponseSchema = exports.startCredentialsImportFlowResponseSchema = _zod.z.object({
  type: _zod.z.literal("startCredentialsImportFlowResponse").optional(),
  success: _zod.z.object({
    credentials: _zod.z.array(credentialsSchema),
...
const apiSchema = exports.apiSchema = _zod.z.object({
  ...
  startCredentialsImportFlow: _zod.z.record(_zod.z.unknown()).and(_zod.z.object({
    id: _zod.z.literal("startCredentialsImportFlowResponse").optional(),
