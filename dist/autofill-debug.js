...
class InterfacePrototype {
  ...
  userTypedInForm() {
    this.deviceApi.notify(new _deviceApiCalls.UserTypedInFormCall({}));
  }
...
class UserTypedInFormCall extends _deviceApi.DeviceApiCall {
  method = "userTypedInForm";
}
exports.UserTypedInFormCall = UserTypedInFormCall;
...
const apiSchema = exports.apiSchema = _zod.z.object({
  ...
  userTypedInForm: _zod.z.record(_zod.z.unknown()).optional()
});
