...
`.trim();
  ...
  var autofill_tooltip_styles_default = `:root {
    ...
    /* --- MacOS Default Theme --- */
    --mac-bg: var(--dialog-mac-backdrop);
    --mac-bg-dark: var(--dialog-mac-backdrop-dark);
    --mac-font-size-primary: 13px;
    --mac-font-size-secondary: 11px;
    --mac-font-weight: 500;
    --mac-padding: 6px;
    --mac-hr-margin: 5px 9px;
    --mac-hover-color: #FFF;
    --mac-hover-bg: #3969EF;
    --mac-hover-effect: invert(100%);
    
    /* --- Windows Default Theme --- */
    --windows-bg: var(--dialog-windows-backdrop);
    --windows-bg-dark: var(--dialog-windows-backdrop-dark);
    --windows-font-size-primary: 14px;
    --windows-font-size-secondary: 12px;
    --windows-font-weight: 400;
    --windows-padding: 2px;
    --windows-hr-margin: 3px 0px;
    --windows-hover-color: inherit;
    --windows-hover-bg: #e0e1e1;
    --windows-hover-effect: none;
}
...
:host {
    ...
    --bg: var(--mac-bg);
    --bg-dark: var(--mac-bg-dark);

    /* Typography */
    --font-size-primary: var(--mac-font-size-primary);
    --font-size-secondary: var(--mac-font-size-secondary);
    --font-weight: var(--mac-font-weight);

    /* Spacing */
    --padding: var(--mac-padding);
    --hr-margin: var(--mac-hr-margin);

    /* Hover Effects */
    --hover-color: var(--mac-hover-color);
    --hover-bg: var(--mac-hover-bg);
    --hover-effect: var(--mac-hover-effect);
}
...
:host:has([data-platform="windows"]) {
    /* Colors */
    --bg: var(--windows-bg);
    --bg-dark: var(--windows-bg-dark);

    /* Typography */
    --font-size-primary: var(--windows-font-size-primary);
    --font-size-secondary: var(--windows-font-size-secondary);
    --font-weight: var(--windows-font-weight);

    /* Spacing */
    --padding: var(--windows-padding);
    --hr-margin: var(--windows-hr-margin);

    /* Hover Effects */
    --hover-color: var(--windows-hover-color);
    --hover-bg: var(--windows-hover-bg);
    --hover-effect: var(--windows-hover-effect);
}
