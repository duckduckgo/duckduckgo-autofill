...
},{"./lib/apple.password":2,"./lib/constants":3,"./lib/rules-parser":4}],2:[function(require,module,exports){
"use strict";
...
},{"./constants":3,"./rules-parser":4}],3:[function(require,module,exports){
"use strict";
...
},{"./DeviceInterface/AndroidInterface":7,"./DeviceInterface/AppleDeviceInterface":8,"./DeviceInterface/ExtensionInterface":9,"./autofill-utils":35}],7:[function(require,module,exports){
"use strict";
...
},{"../autofill-utils":35,"../scanForInputs.js":39,"./InterfacePrototype.js":10}],8:[function(require,module,exports){
"use strict";
...
const {
  Config
} = require('@duckduckgo/content-scope-scripts/src/config/Config');
/**
...
},{"../appleDeviceUtils/appleDeviceUtils":33,"../autofill-utils":35,"../scanForInputs.js":39,"./InterfacePrototype.js":10,"@duckduckgo/content-scope-scripts/src/config/Config":41}],9:[function(require,module,exports){
"use strict";
...
},{"../autofill-utils":35,"../scanForInputs.js":39,"./InterfacePrototype.js":10}],10:[function(require,module,exports){
"use strict";
...
},{"../Form/formatters":14,"../Form/inputTypeConfig":16,"../Form/listenForFormSubmission":18,"../Form/matching":21,"../InputTypes/Credentials":24,"../PasswordGenerator":27,"../UI/DataAutofill":28,"../UI/EmailAutofill":29,"../autofill-utils":35,"../scanForInputs":39}],11:[function(require,module,exports){
"use strict";
...
},{"../autofill-utils":35,"../constants":37,"./FormAnalyzer":12,"./formatters":14,"./inputStyles":15,"./inputTypeConfig.js":16,"./matching":21,"./matching-configuration":20}],12:[function(require,module,exports){
"use strict";
...
},{"../constants":37,"./matching":21,"./matching-configuration":20}],13:[function(require,module,exports){
"use strict";
...
},{"../InputTypes/Credentials":24,"../InputTypes/CreditCard":25,"../InputTypes/Identity":26,"../UI/img/ddgPasswordIcon":31,"../autofill-utils":35,"./logo-svg":19,"./matching":21}],17:[function(require,module,exports){
"use strict";
...
},{"../autofill-utils":35,"../scanForInputs":39}],19:[function(require,module,exports){
"use strict";
...
},{"../constants":37,"./label-util":17,"./vendor-regex":23}],22:[function(require,module,exports){
"use strict";
...
},{"../autofill-utils":35,"./Tooltip":30,"./styles/autofill-tooltip-styles.js":32}],29:[function(require,module,exports){
"use strict";
...
},{"../autofill-utils":35,"./Tooltip":30,"./styles/autofill-tooltip-styles.js":32}],30:[function(require,module,exports){
"use strict";
...
},{"../Form/matching":21,"../autofill-utils":35}],31:[function(require,module,exports){
"use strict";
...
},{"./captureDdgGlobals":34}],34:[function(require,module,exports){
"use strict";
...
},{"./Form/matching":21}],36:[function(require,module,exports){
"use strict";
...
},{"./DeviceInterface":6,"./requestIdleCallback":38}],37:[function(require,module,exports){
"use strict";
...
},{"./Form/Form":11,"./Form/selectors-css":22,"./autofill-utils":35}],40:[function(require,module,exports){
"use strict";
...
class Config {
  ...
  isFeatureRemoteEnabled(featureName, url) {
    const privacyConfig = (0, _appleUtils.processConfig)(_classPrivateFieldGet(this, _config).contentScope, _classPrivateFieldGet(this, _config).userUnprotectedDomains, _classPrivateFieldGet(this, _config).userPreferences, url);
...
},{"../apple-utils.js":40,"./validate.cjs":42}],42:[function(require,module,exports){
"use strict";

module.exports = validate20;
module.exports.default = validate20;
const schema22 = {
  "$id": "content-scope-config",
  ...
  "required": ["contentScope", "userUnprotectedDomains", "userPreferences"]
};
...
function validate20(data) {
  ...
  /*# sourceURL="content-scope-config" */
  ;
  let vErrors = null;
  let errors = 0;
  ...
  if (errors === 0) {
    if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (data.contentScope === undefined && (missing0 = "contentScope") || data.userUnprotectedDomains === undefined && (missing0 = "userUnprotectedDomains") || data.userPreferences === undefined && (missing0 = "userPreferences")) {
        validate20.errors = [{
          instancePath,
          schemaPath: "#/required",
          keyword: "required",
        ...
        if (data.userUnprotectedDomains !== undefined) {
          let data0 = data.userUnprotectedDomains;
          const _errs1 = errors;
            ...
            if (Array.isArray(data0)) {
              ...
              for (let i0 = 0; i0 < len0; i0++) {
                ...
                if (typeof data0[i0] !== "string") {
                  validate20.errors = [{
                    instancePath: instancePath + "/userUnprotectedDomains/" + i0,
                    schemaPath: "#/properties/userUnprotectedDomains/items/type",
                    keyword: "type",
                    params: {
                      type: "string"
                    },
