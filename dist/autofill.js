...
class DDGAutofill {
  constructor(input, associatedForm, getAddresses, refreshAlias, addresses) {
    ...
    const includeStyles = isApp ? "<style>".concat(require('./DDGAutofill-styles.js'), "</style>") : "<link rel=\"stylesheet\" href=\"".concat(chrome.runtime.getURL('public/css/email-autofill.css'), "\" crossorigin=\"anonymous\">");
...
},{"./DDGAutofill-styles.js":1,"./autofill-utils":7}],3:[function(require,module,exports){
"use strict";
...
},{"./DDGAutofill":2,"./appleDeviceUtils/appleDeviceUtils":6,"./autofill-utils":7,"./scanForInputs.js":12}],4:[function(require,module,exports){
"use strict";
...
},{"./FormAnalyzer":5,"./autofill-utils":7,"./logo-svg":10}],5:[function(require,module,exports){
"use strict";
...
let secret = 'PLACEHOLDER_SECRET'; // The native layer will inject a 128-bit tag here and we'll use it for decryption
