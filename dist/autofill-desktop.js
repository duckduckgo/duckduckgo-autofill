...
`.trim();
  ...
  var defaultOptions = {
    ...
    css: `<style>${autofill_tooltip_styles_base_default}</style>`,
    setSize: void 0,
    remove: () => {
    },
    testMode: false,
...
`;
  ...
  var WindowsOverlayDeviceInterface = class extends InterfacePrototype_default {
     ...
     */
    createUIController() {
      const desktopCSS = getDesktopCSS2();
      return new HTMLTooltipUIController(
        {
          tooltipKind: (
            /** @type {const} */
